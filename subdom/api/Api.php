...
define('APP_NAME', 'Seriálovna');
define('APP_ENV', 'production');
define('APP_KEY', 'base64:Vqdi4dd7kAm6oR8h5kTdPswki8zAhgiA1qdbkt+6YvU=');
define('APP_DEBUG', 'true');
define('APP_LOG_LEVEL', 'debug');
define('APP_LOG', 'single');
...
if ( stripos($_SERVER['SERVER_NAME'], 'serialovna.cz') !== false) {
    ...
    define('DB_USERNAME', 'a164792_tvshows');
    define('DB_PASSWORD', 'pFkfWRwf');
} else {
